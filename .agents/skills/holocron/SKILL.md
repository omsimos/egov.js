  ...
  "navigation": {
    ...
    "global": {
      "anchors": [
        ...
        {
          "anchor": "Changelog",
          "href": "https://github.com/example/docs/releases",
...
```mdx
<Aside>
  <Note>This appears in the sidebar with a proper callout frame.</Note>
</Aside>
```
...
<Aside>
  <Info>
    If OIDC is not available, fall back to a **`HOLOCRON_KEY`** environment variable or a session
    token from `holocron login`.
  </Info>
</Aside>
```
